...
const BooksHandler = (() => {
    ...
    return { booksLibrary, Book, addBook, getBooksfromLib }


})();

BooksHandler.addBook("It Works! The Little Red Book", "RHJ", 28, true);
BooksHandler.addBook("A Song of Ice & Fire - A Game of Thrones", "George R.R. Marting", 694);

console.log(BooksHandler.getBooksfromLib());
